    ...
    >
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-5xl font-bold mb-10 bg-black bg-clip-text text-transparent text-center">
            My Projects
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Project 1 */}
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-pink-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition bg-pink-300">
              <h3 className="text-xl font-bold mb-2">On Route</h3>
              <p className="text-gray-500 mb-4">
                A rudimentary hackathon project to assist in safety when
                travelling.
              </p>
      ...
      transition-all bg-pink-300
    "
            >
              <h3 className="text-xl font-bold mb-2">Activity Manager</h3>
              <p className="text-gray-500 mb-4">
                An activity manager designed to help organize activities with
                their locations and reviews.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["Java"].map((tech, key) => (
                  <span
          ...
          "
            ...
            {/* Project 3 */}
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-pink-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition bg-pink-300">
              <h3 className="text-xl font-bold mb-2">Colour Guesser</h3>
              <p className="text-gray-500 mb-4">
            ...
            hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all"
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/SOFTENG281-2025/assignment-2-e10gb.git"
                  className="text-pink-400 hover:text-pink-300 transition-colors my-4"
                >
                  View Project →
                </a>
            ...
            {/* Project 4 */}
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-pink-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition bg-pink-300">
              <h3 className="text-xl font-bold mb-2">Routing Machine</h3>
              <p className="text-gray-500 mb-4">
            ...
            hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all"
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/SOFTENG281-2025/assignment-3-e10gb.git"
                  className="text-pink-400 hover:text-pink-300 transition-colors my-4"
                >
                  View Project →
                </a>
