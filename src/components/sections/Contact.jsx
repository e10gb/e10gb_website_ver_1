          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="relative">
              <input
                ...
                required
                value={formData.name}
                className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-gray transition focus:outline-none focus:border-pink-500 focus:bg-pink-500/5"
                placeholder="Name..."
                onChange={(e) =>
